...
\rput(2.5,-2.3){\resizebox{!}{5.7cm}{{\includegraphics[]{images/radioglud/entrada.eps}}}}
...
% Cabecera
\begin{flushright}
\msection{introcolor}{black}{0.35}{Tecnologías Libres}

\mtitle{10cm}{Emisora en línea con Tecnologías Libres}

\msubtitle{8cm}{Online Broadcasting Station with Free and Open Source Tecnologies}

{\sf Jorge Useche, Ingeniero Electrónico}\\
{\sf Alejando Cortázar, Bachiller Académico}
...
\sectiontext{white}{black}{Palabras clave: } Radio, Online, Comunitaria.
...
\begin{enumerate}
\item ¿Por qué una radio en línea?
\item Conceptos generales sobre servicios o demonios en GNU/Linux.
\item Terminología usada en la transmisión de medios.
\item Piezas de software usadas.
\item Alternativas para emisión de audio y ventajas y desventajas de éstas.
\item ¿Qué música puedo poner?, licencias asociadas.
\item Ilustración general del método usado en Radio GLUD.
\item Instrucciones para la primera emisión en una red local.
\end{enumerate}
...
\sectiontext{white}{black}{II. ¿Por qué una radio en línea?}
...
\sectiontext{white}{black}{III. Conceptos generales sobre servicios o demonios en GNU/Linux}
...
\sectiontext{white}{black}{IV. Terminología usada en la transmisión de medios}
...
\sectiontext{white}{black}{V. Piezas de software usadas}
...
\sectiontext{white}{black}{VI. ¿Qué música puedo poner?, licencias asociadas}
...
\sectiontext{white}{black}{VII. Instrucciones para la primera emisión en una red local}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ebOpage{introcolor}{0.35}{Seccion dejar vacio} % Salto de página 1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
